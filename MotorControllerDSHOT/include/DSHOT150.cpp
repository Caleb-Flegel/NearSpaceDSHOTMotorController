...
void DSHOT150::send_packet() {
    ...
    for(int j = 0; j < 1; ++j) {
        ...
        somewhere between 40,000 and 100,000 or between 50 and 100 ms. Above that, the ESC doesn't interpret things correctly.
